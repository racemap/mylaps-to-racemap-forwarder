...
import { CRLF, MyLapsFunctions, MyLapsIdentifiers, MyLapsDataSeparator, OneHourInMillis, OneSecondInMillis, MyLapsPrefix } from '../src/main/consts';
import type { TPredictionTestTimes, TTestFixtures, TTestState } from '../src/main/types';
import {
  sleep,
  isPortInUse,
  shortIdBuilder,
