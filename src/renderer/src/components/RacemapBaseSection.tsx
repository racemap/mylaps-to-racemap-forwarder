	...
	return (
		<>
			<Flex gap={"8px"} justify="start" align="baseline">
				<RacemapIcon style={{ marginRight: "10px" }} />
			...
			<Row>
				<Col span={13}>
					...
					<TinyExplaination>
						The token gives you access to your Racemap Account. It's{" "}
					...
					<TinyExplaination>
						To select an event is <strong>optional</strong>. When using
						gun-times they will be assigned to the participants listed in the
						event. Otherwise the gun-times will be dropped.
					</TinyExplaination>
				</Col>
